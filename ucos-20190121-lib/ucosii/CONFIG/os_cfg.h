...
#define OS_LOWEST_PRIO           15u   /* 最低优先级*//* Defines the lowest priority that can be assigned ...         */
...
#define OS_MAX_TASKS             14u   /* 最大应用任务数量, 一定>=2 *//* Max. number of tasks in your application, MUST be >= 2       */
...
#define OS_TICKS_PER_SEC       50u   /* 设定一秒节拍的数量 *//* Set the number of ticks in one second                        */
                                                            //1000--》改为50，不需要那个高的中断速率   zhaozhi 20190130
